...
using RebuyBarcode = Acx.Forms.Barcode.Pcl.Barcode;
using Acx.Forms.Barcode.iOS.Extensions;
using System.Diagnostics;
using Acx.Forms.Barcode.Pcl.Logger;
using Acx.Forms.Barcode.iOS.Logger;

[assembly: ExportRenderer(typeof(BarcodeScanner), typeof(BarcodeScannerRenderer))]
namespace Acx.Forms.Barcode.iOS
{
